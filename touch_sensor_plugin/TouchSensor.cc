...
GZ_ADD_PLUGIN(
    ...
    gz::sim::System,
	touch_sensor::TouchSensor::ISystemPreUpdate,
    touch_sensor::TouchSensor::ISystemPostUpdate)

using namespace touch_sensor;

void TouchSensor::PreUpdate(const gz::sim::UpdateInfo &,
	...
	_ecm.EachNew<gz::sim::components::CustomSensor,
		gz::sim::components::ParentEntity>(
				...
				const gz::sim::components::ParentEntity *_parent)-> bool
			{
				...
				if(data.Topic().empty())
				{
					std::string topic = scopedName(_entity, _ecm) + "/my_sensor";
					data.SetTopic(topic);
				}
...
// iteration.
void TouchSensor::PostUpdate(const gz::sim::UpdateInfo &_info,
